  ...
  This is libxmlsec, version 1.2.11, binary package for the native Win32/IA32
platform.
...
make sure that your tools which use libxmlsec can find it.
...
environment variable.
  If you want to make programmes in C which use libxmlsec, you'll
